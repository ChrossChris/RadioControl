...
// Das vierte Modell besitzt derzeit keine eigene Konfigurationsdatei.
#ifndef GRAUPNER_AMIGO4
...
#define TFT_DATA        10
#define TFT_CHIP_SELECT 9
#define TFT_RESET       8
#define BUZZER          3

ILI9341 tft = ILI9341(TFT_DATA, TFT_RESET, TFT_CHIP_SELECT);
RREFont font;

void customRect(int x, int y, int w, int h, int color)
{
...
void loop()
{
  ...
  // ----------------------------------------------------------------------------------
  // Das ehemalige zweite Display ist jetzt Screen 5 auf demselben TFT.
  if (statusScreen != statusScreenOld) tft.fillScreen(BLACK);
  switch (statusScreen)
  {
    case 0:
      displayStatus();
      break;
    case 1:
      displayAddFunctionsNumeric();
      break;
    case 2:
      displayJoystickPosition();
      break;
    case 3:
      displayJoystickLimits();
      break;
    case 4:
      ...
      break;
    case 5:
      displayAddFunctionsGraphic();
      break;
    default:
      displayUnknownScreen();
      break;
  }
