...
{  
  ...
  if (pulse) 
  { 
    digitalWrite(CPPM_PORT, HIGH);         // Puls wird gesetzt
  ...
  { 
    digitalWrite(CPPM_PORT, LOW);    // Puls wird zurückgesetzt, Pause im PPM-Signal (Servoauslenkung codiert durch die Länge der Pause)
