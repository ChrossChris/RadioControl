...
#define JOYST_MOTOR         A0
#define JOYST_SEITE         A2
#define JOYST_HOEHE         A4
#define JOYST_QUER          A6
#define TRIMM_MOTOR         A1
#define TRIMM_SEITE         A3
#define TRIMM_HOEHE         A5
#define TRIMM_QUER          A7

#define POTI_MAIN           A8
#define POTI_RECHTS_1       A9  // Center Left
#define POTI_RECHTS_2       A10 // Center Right
#define POTI_LINKS_1        A11
#define POTI_LINKS_2        A12 

#define BUTTON              25
#define SWITCH_RECHTS_OBEN  32 // Center Left
#define SWITCH_RECHTS_UNTEN 33 // Center Right
#define SWITCH_LINKS_OBEN   27 
#define SWITCH_LINKS_UNTEN  29 
#define ON                  true
#define OFF                 false

// Poti-Limit
#define POTI_HOEHE_MIN      -389   // Ausschlag unten
#define POTI_HOEHE_MAX       382   // Ausschlag oben
#define POTI_SEITE_MIN      -416   // Ausschlag links
#define POTI_SEITE_MAX       390   // Ausschlag rechts
#define POTI_QUER_MIN       -397   // Ausschlag links
#define POTI_QUER_MAX        414   // Ausschlag rechts
#define POTI_MOTOR_MIN         0   // Ausschlag unten
#define POTI_MOTOR_MAX       785   // Ausschlag oben
  

// Steuerungseinstellungen
#define CONTROL_LIMIT       1000
#define CENTER_POS          512
#define CENTER_TRIM         512 
#define DEADZONE            128
...
#define CPPM_PORT           3     // Output-Pin
#define FRAME_LENGTH        23000  // 23ms  Paketlänge
#define PULSE_LENGTH        250    // 420µs Pulslänge (200µs..500µs) (gemessen an FM6014)
